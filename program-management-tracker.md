...
[Messaging][2] | ![CHARTREUSE][98] | New next step is working via Kimberly Craven to get help honing<br/>Needs community mailing list discussions and ODF-style to finalize<br/>**Action:**  As part of honing, start messaging thread on mailing list about the state of messaging and where decisions/consensus is needed
[Website changes][3] | ![CHARTREUSE][98] | Engaging with kcraven to find resources, may need external firm;<br/>Goal is to have an ODF-style interaction between web dev team and community on mailing list and via PRs<br/>**Action:**  Engage with web dev team
[Contributor experience][4] | ![YELLOW][97] | New contributor experience is rough and confusing<br/>Community Handbook effort should help, but a critical threshhold in the Community Handbook is needed to make it through good-enough tiers: ready for experienced people, ready for some level of close assistance, ready for anyone, etc.<br/>**Action:**  Drive thread on mailing list about the Handbook and *handbook-first* philosophy<br/>Ask for commitments, volunteers to get handbook rolling<br/>**Blocked on needing a UX SME to consult and/or do stuff.**
...
[Metrics plan][6] | ![YELLOW][97] | New efforts underway to capture the baseline, such as [this Jupyter Notebook](https://github.com/operate-first/community/pull/80).<br/>Need to move from ad-hoc to strategic<br/>**Action:** Discussion and  workstream team to define and run this metrics effort.
...
[Learning paths][10] | ![CHARTREUSE][98] | A lot of internal alignment happening, will be looking to start SRE community of practice at OI Labs soon<br/>Need to start creating learning paths on website using new TBD format<br/>Time to bring @<br/>**Blocked on ongoing OI Labs discussion**<br/>**Action:** Ask learning team to begin engaging via GitHub on building knowledge pool and corresponding pathways
[Event planning][11] | ![GREEN][99] | Work underway to produce content and  presentations for Open Source Summit and All Things Open<br/>@quaid attending KubeCon in October to scope for 2022<br/>**Action:** Start looking for what to submit to next
